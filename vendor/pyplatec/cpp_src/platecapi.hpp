...
/* worldsim Milestone 3: take lithosphere pointer (same as other getters). */
const uint32_t* platec_api_get_agemap(void*);
...
float platec_api_get_plate_speed(void*, uint32_t plate_index);
